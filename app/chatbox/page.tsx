...
export default function ChatBox() {
    ...
    const responses: Record<string, string> = {
        ...
        "I am feeling sick": "I'm sorry to hear that. Can you explain how you are feeling exactly.",
    ...
    return (
       <div className="max-w-md mx-auto mt-5 bg-white shadow-lg rounded-xl overflow-hidden">
            ...
            <div className="p-4 space-y-3 h-72 overflow-y-auto">
                {messages.map((msg, index) => (
                    ...
                    >
                        <div
                            className={`px-4 py-2 rounded-lg max-w-xs break-words ${msg.type === "user"
